          ...
          child: Wrap(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  context.read<SignUpBloc>().add(PickImageFormGallery());
                },
              ),
              const Divider(),
              ListTile(
                ...
                onTap: () {
                  context.read<SignUpBloc>().add(PickImageFormCamera());
                },
              ),
            ],
          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CommonWidgets.commonTextField(
                            ...
                            onChanged: (password) => context
                                .read<SignUpBloc>()
                                .add(CnfPasswordChange(password)),
                          ),
